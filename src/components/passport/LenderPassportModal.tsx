    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg rounded-2xl bg-white p-5 shadow-xl sm:p-6 max-h-[90vh] overflow-y-auto">
        <div className="mb-4 flex items-start justify-between">
          <div>
            <p className="text-xs font-medium uppercase tracking-wide text-slate-400">Lender Trust Passport</p>
            ...
            <p className="text-slate-400 text-xs mt-0.5">{passport.type}</p>
          </div>
        ...
        <div className="flex items-center gap-4 rounded-xl bg-slate-50 p-4">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-800">{bandLabel} trust score</p>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
          <div className="flex items-center gap-2 rounded-xl border border-slate-100 px-3 py-2.5">
            ...
            <div>
              ...
              <p className="text-slate-800 font-medium">{passport.yearsActive} yr{passport.yearsActive === 1 ? "" : "s"}</p>
            </div>
          </div>
          <div className="flex items-center gap-2 rounded-xl border border-slate-100 px-3 py-2.5">
            <Users size={14} className="text-slate-400" />
            <div>
              <p className="text-slate-400 text-[11px]">Borrowers served</p>
              <p className="text-slate-800 font-medium">{passport.borrowersServed.toLocaleString("en-IN")}</p>
            </div>
          </div>
        </div>

        <div className="mt-5 space-y-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Trust breakdown</p>
